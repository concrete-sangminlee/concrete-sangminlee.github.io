...
* **Ph.D. Candidate** (2023.03.-2027.02., expected)  
...
* **M.S.** (2021.03.-2023.02.)  
   * Architecture and Architectural Engineering, **Seoul National University**  
         ...
         * Advisor: Prof. Thomas H.-K. Kang  
         * Thesis: _Machine Learning Application to Automated Impact-Echo Test for Concrete Structures_
...
* AI for resilient infrastructure and structural health monitoring
* Machine learning applications to structural engineering and materials
* Wind engineering and wind load estimation using AI
* Smart infrastructure and IoT-based monitoring systems
* Large language models for engineering standards and design codes
* Automated non-destructive testing and defect detection
* Real-time structural health monitoring using deep learning

# Honors & Awards

* **SNU AI Fellowship** (2025.09., 2025.03.)  
...
* **Big Data Analysis Engineer (빅데이터분석기사)** (2025.07)  
   * Korea Data Industry Promotion Agency (한국데이터산업진흥원)  
   * Certificate Number: BAE-010003675

# Service and Leadership

* **Conference Organizing Committee Member** (2025.04 - 2025.05)  
   * Wind Engineering Institute of Korea  
   * Organizing Committee Member for the 28th Wind Engineering Institute of Korea Annual Conference and General Assembly (Seoul National University)

* **Math Teacher / Operation Lead** (2016.07 - 2018.01)  
   * Sharing Knowledge (배움을 나누는 사람들)  
   * Math Teacher for Near-Poverty Students / Operation Lead for Uiwang Bu-gok Education Center (Representative Teacher)
...
* **AI-Based Internal Defect Detection System for Concrete Members** (2023.12.04)  
   * Patent Number: 1020230000782  
   * Applied to PCT & US patent & EU patent  
   * Registered patent in Korea

* **AI-Based Wind Load Estimation System** (2022.12.19)  
   * Patent Number: 1020220060319  
   * Applied to PCT  
   * Registered patent in Korea

# Publications

I have published **28 papers** in top-tier journals and conferences. For a complete list of publications, please visit the [Publications](/publications/) page.
